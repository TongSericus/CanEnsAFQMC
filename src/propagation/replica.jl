...
function propagate!_replica(
    ...
    trialwalker1 = calc_trail_mcmc(
        system, walker1, walker1.auxfield[:, field_index[1]]
    )
    trialwalker2 = calc_trail_mcmc(
        system, walker2, walker2.auxfield[:, field_index[1]]
    )
    # weight ratio between the new and the old configurations
    ratio1 = (trialwalker1.weight[1] / walker1.weight[1]) * (trialwalker1.weight[2] / walker1.weight[2])
    ratio2 = (trialwalker2.weight[1] / walker2.weight[1]) * (trialwalker2.weight[2] / walker2.weight[2])
    ...
    elseif index == 2
        ...
        walker1.weight .= [trialwalker1.weight[1], trialwalker1.weight[2]]
        update_matrices!(
    ...
    elseif index == 3
        ...
        flip!(walker1.auxfield, field_index[2], field_index[1])
        walker2.weight .= [trialwalker2.weight[1], trialwalker2.weight[2]]
        update_matrices!(
