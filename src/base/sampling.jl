Base.@kwdef struct MCSample
    ...
    nk::Vector{Vector{ComplexF64}} = Vector{Vector{ComplexF64}}()
    Css::Vector{Vector{ComplexF64}} = Vector{Vector{ComplexF64}}()
    expS2::Vector{ComplexF64} = ComplexF64[]
    expS2n::Vector{Matrix{ComplexF64}} = Vector{Matrix{ComplexF64}}()
end
